(function(window){
    var obj = {
      "posts": [
        ...
        {
          "id": 1,
          "title": "wacul技術ブログはQiita Organizationに投稿することになりました",
          "href": "http://blog.wacul.co.jp/blog/2015/07/24/qiita/",
          "teaser": "&lt;p&gt;今後、本wacul技術ブログはQiita Organizationに投稿します。&lt;br/&gt;技術情報の発信は以下のページより行っていきますので、どうぞよろしくお願い致します。&lt;br/&gt;&lt;a href=&quot;http://qiita.com/organizations/wacul&quot;&gt;株式会社wacul の Qiita Organizationページ&lt;/a&gt;&lt;/p&gt;",
          "date": new Date(
            2015,
            7 - 1,
            24
        ...
        {
          "id": 2,
          "title": "AngularJSで全てのng-clickに2重クリック防止機能を付ける",
          "href": "http://blog.wacul.co.jp/blog/2015/02/17/ngclick_waits_promise/",
          "teaser": "&lt;h2&gt;概要&lt;/h2&gt;&lt;p&gt;Angularの標準のdirectiveである&lt;code&gt;ng-click&lt;/code&gt;に、返り値がpromiseの場合に解決されるまでクリックを防止する機能を付けてみました(&lt;a href=&quot;http://embed.plnkr.co/C3vvQdUmTVp3nTXYLdFD/preview&quot;&gt;ボタンを押したら1秒間クリックが無効化されるデモ&lt;/a&gt;)。とても簡単に実装できるのでちょっと紹介してみます。&lt;/p&gt;&lt;h2&gt;実装&lt;/h2&gt;&lt;p&gt;とりあえず元の実装を見てみましょう(&lt;a href=&quot;https://github.com/angular/angular.js/blob/e057a9aa398ead209bd6bbf76e22d2d5562904fb/src/ng/directive/ngEventDirs.js#L44-L77&quot;&gt;githubのソース&lt;/a&gt;)。&lt;/p&gt;&lt;figure class=&#39;code&#39;&gt;&lt;figcaption&gt;&lt;span&gt;&lt;/span&gt;&lt;/figcaption&gt;&lt;div class=&quot;highlight&quot;&gt;&lt;table&gt;&lt;tr&gt;&lt;td class=&quot;gutter&quot;&gt;&lt;pre class=&quot;line-numbers&quot;&gt;&lt;span class=&#39;line-number&#39;&gt;1&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;2&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;3&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;4&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;5&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;6&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;7&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;8&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;9&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;10&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;11&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;12&lt;/span&gt;&lt;span class=&#39;line-number&#39;&gt;13&lt;/span&gt;&lt;span &amp;hellip;",
          "date": new Date(
            2015,
            2 - 1,
            17
        ...
        {
          "id": 3,
          "title": "Markdownを簡単にリアルタイムに共有するShare!をリリースしました",
          "href": "http://blog.wacul.co.jp/blog/2015/02/11/share/",
          "teaser": "&lt;h2&gt;はじめに&lt;/h2&gt;&lt;p&gt;最近、株式会社waculでは月に1度に開発合宿と称し、プログラマチームで業務とは別の開発を行っています。今回ご紹介させていただく&lt;a href=&quot;http://shareapp.wacul.jp&quot;&gt;Share!&lt;/a&gt;は1月、2月の開発合宿で実装したアプリケーションです。&lt;/p&gt;&lt;h2&gt;Share!とは&lt;/h2&gt;&lt;p&gt;ミーティング中に書いている議事録を参加者全体に共有したいケースがよくありました。今までそういったケースではGoogleドライブのドキュメントを作成し、そこで共有していました。しかし、ドキュメントでは以下のような問題がありました。&lt;/p&gt;&lt;ul&gt;&lt;li&gt;普段使っているエディタを使えない&lt;/li&gt;&lt;li&gt;スタイルを整えるのが手間&lt;/li&gt;&lt;li&gt;ドキュメントを作って共有するというステップが面倒&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;そこで我々はこれらを解決するため、ローカルで作成したMarkdown形式のテキストファイルを簡単にリアルタイムに共有するアプリケーションの開発を行いました。&lt;/p&gt;&lt;h2&gt;Share!の動作&lt;/h2&gt;&lt;p&gt;テキストを共有する側は専用のアプリケーションをダウンロードする必要があります。アプリケーションを起動すると、以下のような画面が表示されるので、ここにテキストファイルをドラッグアンドドロップします。&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;/images/2015-02-11-share/dragdrop.png&quot; alt=&quot;share drag and drop&quot; /&gt;&lt;/p&gt;&lt;p&gt;そうすると、ブラウザが自動的に立ち上がり、ドラッグアンドドロップしたファイルが表示されます。&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;/images/2015-02-11-share/browser.png&quot; alt=&quot;share browser&quot; /&gt;&lt;/p&gt;&lt;p&gt;このとき、ユニークなランダムなURLが割り振られるので、このURLを共有したい相手に伝えます。共有された側は共同編集を行うことはできませんが、リアルタイムに共有した側の編集状況を見ることができます。&lt;/p&gt;&lt;h2&gt;Download&lt;/h2&gt;&lt;p&gt;アプリケーションは以下からダウンロードできます。&lt;/p&gt;&lt;ul&gt;&lt;li&gt;Windows版 &lt;a href=&quot;/zip/2015-02-11-share/share-win64.zip&quot;&gt;Download&lt;/a&gt;&lt;/li&gt;&lt;li&gt;Mac版 &lt;a href=&quot;/zip/2015-02-11-share/share-osx64.zip&quot;&gt;Download&lt;/a&gt;&lt;/li&gt;&lt;/ul&gt;",
          "date": new Date(
            2015,
            2 - 1,
            11
